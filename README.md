...
**Full VM install (every tool, in order):** see **[INSTALLATION.md](./INSTALLATION.md)** — system packages, Node.js 24+, pnpm, dependencies, database, and production (pm2 / Caddy).
